...
namespace Billing_Client_V1 {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class MenuDataTable : global::System.Data.TypedTableBase<MenuRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public MenuRow AddMenuRow(string Item_Code, string Item_Name, string Price, string Status) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public MenuRow FindByItem_Code(string Item_Code) {
        ...
        public partial class MenuRow : global::System.Data.DataRow {
            ...
            public string Item_Code {
                get {
                    return ((string)(this[this.tableMenu.Item_CodeColumn]));
                }
                set {
...
namespace Billing_Client_V1.masterDataSetTableAdapters {
    ...
    public partial class MenuTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Menu] WHERE (([Item_Code] = @Original_Item_Code) AND ([Item_Na" +
                "me] = @Original_Item_Name) AND ([Price] = @Original_Price) AND ((@IsNull_Status " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Menu] ([Item_Code], [Item_Name], [Price], [Status]) VALUES (@I" +
                "tem_Code, @Item_Name, @Price, @Status);\r\nSELECT Item_Code, Item_Name, Price, Sta" +
                "tus FROM Menu WHERE (Item_Code = @Item_Code)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Menu] SET [Item_Code] = @Item_Code, [Item_Name] = @Item_Name, [Price] = @Price, [Status] = @Status WHERE (([Item_Code] = @Original_Item_Code) AND ([Item_Name] = @Original_Item_Name) AND ([Price] = @Original_Price) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT Item_Code, Item_Name, Price, Status FROM Menu WHERE (Item_Code = @Item_Code)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Item_Code, Item_Name, Price, Status FROM dbo.Menu";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Item_Code, Item_Name, Price, Status FROM dbo.Menu";
        ...
        public virtual int FillBy(masterDataSet.MenuDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Item_Code, string Original_Item_Name, string Original_Price, string Original_Status) {
        ...
        public virtual int Insert(string Item_Code, string Item_Name, string Price, string Status) {
            if ((Item_Code == null)) {
        ...
        public virtual int Update(string Item_Code, string Item_Name, string Price, string Status, string Original_Item_Code, string Original_Item_Name, string Original_Price, string Original_Status) {
            if ((Item_Code == null)) {
                throw new global::System.ArgumentNullException("Item_Code");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item_Name, string Price, string Status, string Original_Item_Code, string Original_Item_Name, string Original_Price, string Original_Status) {
            return this.Update(Original_Item_Code, Item_Name, Price, Status, Original_Item_Code, Original_Item_Name, Original_Price, Original_Status);
        }
    }
