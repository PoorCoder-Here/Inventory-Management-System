namespace Billing_Client_V1
{
	partial class Passwrd_change
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Passwrd_change));
			...
			this.Name = "Passwrd_change";
			this.Text = "Passwrd_change";
			this.Load += new System.EventHandler(this.Passwrd_change_Load);
